...
def transition_model(corpus, current_page, damping_factor):
    ...
    """
    N = len(corpus)
    linked_pages = corpus[current_page]
    number_linked = len(linked_pages)
    probabilities = dict()
    ...
    for page in corpus:
        probabilities[page] = damping_probability

    principal_probability = damping_factor / number_linked
